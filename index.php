    ...
    <body>
        ...
        <center>
            ...
            <div class="container-sm p-3 w-50 mb-2 rounded-3 border border-warning border-5 text-white">
                <p class="h4 text-warning">Pentakill es una banda de heavy metal del universo de League of legends. Esta banda vuelve este año
...
<html lang="es-ES">
    ...
    <body>
        ...
        <center>
            ...
            <!--/Header-->
            <!--Contenido-->
            <br><br><div class="container-sm p-3 mb-2 rounded-3 border border-warning border-5 text-warning col-4">
                <form action= "login.php" method= "POST">
                    <h2 style="color:gold" align="middle">Iniciar Sesion</h2><br>
                    <div class="mb-3">
                        <label class="form-label">Nombre de Usuario</label>
                        <input type="text" class="form-control" id="Usuario" name="Usuario" placeholder="Nombre de Usuario" />
                    </div>
                    ...
                    <input type="submit"  value="Iniciar Sesion" class="btn btn-warning">
                    <button type="button" class="btn btn-secondary" onclick="location.href='DatosPersonales.php'">Registrarse</button>
                </form>
            </div><br><br>
            <!--/Contenido-->
